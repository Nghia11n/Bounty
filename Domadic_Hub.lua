...
local LogoHub = Instance.new("ImageLabel")
    ...
    LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(17565248310)
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(17565248310)
...
H:AddLabel("Script On Top")
H:AddLabel("Welcome To Kee Hub")
...
M:AddToggle("Auto Find Full Moon",_G.AutoFindFullmoon,function(value)
 ...
 spawn(function()
        while wait() do
            ...
            if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17565248310" or game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=17565248310" then
                wait(2.0)
                game.StarterGui:SetCore("SendNotification", {
					Title = "Domadic Hab", 
					Text = "Full Moon" ,
...
print("Kee Hub Tải Thành Công")

game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=17565248310";
      Title = "Kee Hub", 
      Text = "Welcome To Kee Hub";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "http://www.roblox.com/asset/?id=17565248310";
